...
def estrai_negozi_sottocategorie(categorie, LINK, PRE_LINK_ANNUNCIO,sec_categoria, sec_sottocategoria, sec_pages, sec_pausa_errore, tentativi, categorie_negozi):
#     count = 0
...
#             print(count)
            ...
            for sottocategoria in sottocategorie:
                ...
                if controllo[1]<tentativi:
                    aziende = controllo[0]
                    categorie_negozi[str(categoria)+";"+str(sottocategoria[0])] = aziende
